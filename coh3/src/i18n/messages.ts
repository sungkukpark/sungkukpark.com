...
const en = {
  ...
  hub: {
    ...
    browseAllUnits: "Browse all units",
    categoriesTitle: "Categories",
    categoriesHint:
      "On the list page, toggle factions (Allies/Axis select both sides); combine any mix. Use All for every faction.",
  ...
  list: {
    ...
    factionAll: "All",
    categoryAll: "All",
    allFactionsLabel: "All factions",
    noUnits: "No units in this category.",
    noFactionsSelected: "Select at least one faction to show units.",
    factionSelectionCount: (n: number) => `${n} factions`,
    loading: "Loading…",
...
const ko: typeof en = {
  ...
  hub: {
    ...
    chooseFaction: "진영 선택",
    browseAllUnits: "전체 유닛 보기",
    categoriesTitle: "카테고리",
    categoriesHint:
      "목록에서 진영을 토글하세요(연합·축은 양쪽 진영 동시). 원하는 조합으로 골라 비교할 수 있습니다.",
  ...
  list: {
    ...
    factionAll: "전체",
    categoryAll: "전체",
    allFactionsLabel: "모든 진영",
    noUnits: "이 카테고리에 유닛이 없습니다.",
    noFactionsSelected: "유닛을 보려면 진영을 하나 이상 선택하세요.",
    factionSelectionCount: (n: number) => `진영 ${n}개`,
    loading: "불러오는 중…",
